...
if (isset($_POST['submit'])) {
    ...
    if (
        ...
        if ($user_row->num_rows> 0) {
            ...
            $sql = "INSERT INTO users(fname, lname, email, gender, course, it_center, `address`, `password`, `role`) VALUES('$fname', '$lname', '$email', '$gender', '$course', '$it_center', '$address', '$hash_password', '$role')";
            $result = $db->query($sql);
    ...
    <main class="container mt-2">
        <div class="row justify-content-center">
            <section class="slider col-md-6 mt-5">
                <h4 class="course-title">Registration</h4>
                <?php if ($error) {
