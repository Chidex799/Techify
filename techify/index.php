...
<body style="background: rgb(242,241,237);">
    <div class="row header-top container-fluid">
        <a class="navbar-brand" href="index.php">
            <img src="images/smartcoderound.png" height="50px"></a>
    </div>
    ...
    <main class="container mt-2">
            ...
            <section class="slider col-md-8">
                <div class="carousel slide" id="imgslider" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#imgslider" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#imgslider" data-bs-slide-to="1" aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#imgslider" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    </div>
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="images/student3.jpg" class="d-block w-100 img-thumbnail">
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <section class="card col-md-4 mb-3">
                <div class="">
                    <img src="images/christian2.jpg" class="rounded-circle mt-1" height="90px" width="90px">
                    <p class="mt-2"><b>Christian Chime</b></p>
                    <p class="text-justify"><i>"I’m sure you are proud of your employees and the way they represent both you and your company. I will highly recommend you to anyone needing to learn a course"</i>
                    </p>
                </div>
            </section>
            <section class="card col-md-4 mb-3">
                <div class="">
                    <img src="images/caleb.jpg" class="rounded-circle mt-2" height="90px" width="90px">
                    <p class="mt-1"><b>Caleb Saidu</b></p>
                    <p class="text-justify"><i>"You guys are so great! Thank you so much for your help. Look forward to working with you again in the future."</i>
                    </p>
                </div>
            </section>
        </div>
